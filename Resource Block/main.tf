...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    Name = "MyVPC" # Tag the VPC for identification
  }
}
...
resource "aws_internet_gateway" "my_igw" {
  ...
  tags = {
    Name = "MyInternetGateway" # Tag for the Internet Gateway
  }
}
...
resource "aws_subnet" "public_subnet_1" {
  ...
  tags = {
    Name = "PublicSubnet1" # Tag for the subnet
  }
}
...
resource "aws_subnet" "private_subnet_1" {
  ...
  tags = {
    Name = "PrivateSubnet1" # Tag for the private subnet
  }
}
...
resource "aws_nat_gateway" "my_nat_gateway" {
  ...
  tags = {
    Name = "MyNATGateway" # Tag for the NAT Gateway
  }
}
...
resource "aws_route_table" "public_route_table" {
  ...
  tags = {
    Name = "PublicRouteTable" # Tag for the public route table
  }
}
...
resource "aws_route_table" "private_route_table" {
  ...
  tags = {
    Name = "PrivateRouteTable" # Tag for the private route table
  }
}
